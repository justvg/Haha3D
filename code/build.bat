...
set CommonLinkerFlags=-incremental:no -opt:ref user32.lib gdi32.lib opengl32.lib glew32s.lib -ignore:4099
...
REM 64-bit build
cl %CommonCompilerFlags% "..\Haha3D\code\haha3d.cpp" -Fmhaha3d.map -LD /link -incremental:no -PDB:haha3d_%random%.pdb -EXPORT:GameUpdateAndRender
